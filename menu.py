...
def escolhe_menu(menu):
    opcao = {1:'teste.1.sprite.png', 2:'teste.2.sprite.png', 3:'teste.3.sprite.png'}
    return opcao[menu]
#----------------------------------------------------------------
...
def menu(placarfinal, tempofinal):
    ...
    fundoprincipal = pygame.image.load('fundoprincipal.sprite.png')
    p1 = pygame.image.load(escolhe_menu(menu))
    mc1 = pygame.image.load('mcqueen1.sprite.png')
    mc2 = pygame.image.load('mcqueen2.sprite.png')
